            ...
            <nav class="joe_header__above-nav">
                ...
                <?php if (count($pages->stack) <= $this->options->JNavMaxNum) : ?>
                    <?php foreach ($pages->stack as $item) : ?>
                        ...
                        ?>
                        <a class="item <?php echo $this->is('page', $slug) ? 'active' : '' ?>" href="<?php echo $permalink; ?>" title="<?php echo $title; ?>"><?php echo $title; ?></a>
                    <?php endforeach; ?>
                <?php else : ?>
                    ...
                    <div class="joe_dropdown" trigger="hover" placement="60px" style="margin-right: 15px;">
                        ...
                        <nav class="joe_dropdown__menu">
                            <?php foreach (array_slice($pages->stack, $this->options->JNavMaxNum) as $item) : ?>
                                ...
                                $slug = isset($item['slug']) ? $item['slug'] : '';
                                ?>
                                <a class="<?php echo $this->is('page', $slug) ? 'active' : '' ?>" href="<?php echo $permalink; ?>" title="<?php echo $title; ?>"><?php echo $title; ?></a>
                            <?php endforeach; ?>
                        </nav>
                    </div>
                <?php endif; ?>
